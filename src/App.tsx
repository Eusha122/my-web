...
import { Github, Linkedin, Mail, MapPin, Phone, Download, Menu, X, ExternalLink, Trophy, Code, BookOpen, Folder, Star, Calendar, Eye, Camera } from 'lucide-react';
...
function App() {
  ...
  const projects = [
    {
      id: 1,
      title: "Invisible Cloth",
      description: "A real-time computer vision application that creates an invisibility cloak effect using OpenCV and color detection. Captures background and makes red objects disappear in real-time.",
      language: "Python",
  ...
  const InvisibleClothDemo = () => {
    ...
    return (
      <div className="bg-slate-900/80 rounded-xl p-8 border border-red-500/30">
        <div className="text-center mb-6">
          <h3 className="text-2xl font-bold text-white mb-2 flex items-center justify-center gap-2">
            <Eye className="text-red-400" size={28} />
            Invisible Cloth Demo
          </h3>
          <p className="text-gray-300">Experience the magic of computer vision invisibility</p>
        </div>
        ...
        <div className="relative bg-black rounded-lg overflow-hidden mb-6" style={{ aspectRatio: '16/9' }}>
          {phase === 'idle' && (
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-400 mb-4">Click start to begin the invisibility demo</p>
                <button
                  onClick={startDemo}
          ...
          {phase === 'countdown' && (
            <div className="absolute inset-0 flex items-center justify-center bg-red-900/20">
              <div className="text-center">
                ...
                <p className="text-white text-lg">Hide from the camera!</p>
                <p className="text-gray-300 text-sm">Capturing background...</p>
              </div>
            </div>
          )}
          ...
          {phase === 'active' && (
            <div className="absolute inset-0">
              <div className="w-full h-full bg-gradient-to-br from-blue-900/30 to-purple-900/30 relative">
                {/* Simulated camera feed with invisibility effect */}
                <div className="absolute inset-4 border-2 border-red-400/50 rounded-lg">
                  <div className="w-full h-full bg-gradient-to-br from-slate-800 to-slate-700 rounded-lg relative overflow-hidden">
                    {/* Background pattern */}
                    ...
                    {/* Invisible effect simulation */}
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                      <div className="w-32 h-40 border-2 border-red-400/70 border-dashed rounded-lg animate-pulse">
                        <div className="w-full h-full bg-red-500/20 rounded-lg flex items-center justify-center">
                          <span className="text-red-400 text-xs font-medium">INVISIBLE</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-center">
                  <p className="text-white font-medium">Invisibility Cloak Active!</p>
                  <p className="text-gray-300 text-sm">Red objects are now invisible</p>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div className="bg-slate-800/50 p-3 rounded-lg">
            <div className="text-green-400 font-medium mb-1">✓ Background Captured</div>
            <div className="text-gray-400">Static background frame stored</div>
          </div>
          <div className="bg-slate-800/50 p-3 rounded-lg">
            <div className="text-blue-400 font-medium mb-1">⚡ Real-time Processing</div>
            <div className="text-gray-400">HSV color space detection</div>
          </div>
        </div>

        <div className="mt-4 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
          <p className="text-red-400 font-medium mb-2">How it works:</p>
          <ul className="text-gray-300 text-sm space-y-1">
            <li>• Captures background without the person</li>
            <li>• Detects red color in HSV color space</li>
            <li>• Replaces red areas with background pixels</li>
            <li>• Creates real-time invisibility effect</li>
          </ul>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-pink-900">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 bg-slate-900/70 backdrop-blur-xl border-b border-pink-500/20 z-50 rounded-b-2xl mx-4 mt-2">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-8">
              {['Home', 'About', 'Projects', 'Skills', 'Contact'].map((item) => (
                <button
                  ...
                  className={`px-3 py-2 text-sm font-medium transition-all duration-300 rounded-lg hover:bg-pink-500/10 ${
            ...
            <div className="md:hidden">
              <button
                ...
                className="p-2 rounded-md text-gray-300 hover:text-pink-400 hover:bg-slate-800/50 transition-all duration-200"
              >
          ...
          {/* Mobile Navigation */}
          {isMenuOpen && (
            <div className="md:hidden border-t border-pink-500/20 bg-slate-900/95 rounded-b-xl">
              <div className="px-2 pt-2 pb-3 space-y-1">
                {['Home', 'About', 'Projects', 'Skills', 'Contact'].map((item) => (
                  <button
                    key={item}
                    onClick={() => scrollToSection(item.toLowerCase())}
                    className="block w-full text-left px-3 py-2 text-base font-medium text-gray-300 hover:text-pink-400 hover:bg-slate-800/50 rounded-md transition-all duration-200"
                  >
                    {item}
                  </button>
                ))}
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-wrap gap-4">
                <button 
                  ...
                  className="bg-gradient-to-r from-pink-500 to-blue-500 text-white px-8 py-3 rounded-lg font-medium hover:from-pink-600 hover:to-blue-600 transition-all duration-200 flex items-center gap-2 shadow-lg hover:shadow-pink-500/25 hover:scale-105"
                >
                  <Folder size={20} />
                  View Projects
                </button>
                <button 
                  ...
                  className="border-2 border-pink-400 text-pink-400 px-8 py-3 rounded-lg font-medium hover:bg-pink-400 hover:text-white transition-all duration-200 hover:scale-105"
                >
                  Get In Touch
                </button>
              </div>
              ...
              <div className="flex space-x-6">
                <a href="#" className="text-gray-400 hover:text-pink-400 transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(244,114,182,0.6)]">
                  <Github size={24} />
                </a>
                <a href="#" className="text-gray-400 hover:text-pink-400 transition-all duration-300 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(244,114,182,0.6)]">
                  <Code size={24} />
      ...
      <section id="projects" className="py-20 bg-slate-900/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {projects.filter(project => project.featured).map((project) => (
                <div key={project.id} className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 rounded-xl p-8 border border-pink-500/20 hover:border-pink-400/40 transition-all duration-300 shadow-lg hover:shadow-pink-500/10">
                  ...
                  <div className="flex gap-4">
                    <a 
                      href={project.github} 
                      className="flex items-center gap-2 text-gray-300 hover:text-pink-400 transition-all duration-200 hover:scale-105"
                    >
                      <Github size={16} />
                    ...
                    {project.isInvisibleCloth ? (
                      <button 
                        onClick={() => {
                          const demoElement = document.getElementById('invisible-cloth-demo');
                          if (demoElement) {
                            demoElement.scrollIntoView({ behavior: 'smooth' });
                          }
                        }}
                        className="flex items-center gap-2 text-gray-300 hover:text-red-400 transition-all duration-200 hover:scale-105"
                      >
                        <Eye size={16} />
                      ...
                      <a 
                        href={project.demo} 
                        className="flex items-center gap-2 text-gray-300 hover:text-blue-400 transition-all duration-200 hover:scale-105"
                      >
          ...
          {/* Invisible Cloth Demo Section */}
          <div id="invisible-cloth-demo" className="mb-12">
            <InvisibleClothDemo />
          </div>
                ...
                <div key={project.id} className="bg-slate-800/60 rounded-xl p-6 border border-slate-700/50 hover:border-blue-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-3">
                      <a href={project.github} className="text-gray-400 hover:text-pink-400 transition-all duration-200 hover:scale-110 hover:drop-shadow-[0_0_6px_rgba(244,114,182,0.6)]">
                        <Github size={14} />
                      </a>
                      {project.isInvisibleCloth ? (
                        <button 
                          ...
                          className="text-gray-400 hover:text-red-400 transition-all duration-200 hover:scale-110 hover:drop-shadow-[0_0_6px_rgba(239,68,68,0.6)]"
                        >
                          <Eye size={14} />
                        </button>
                      ) : (
                        <a href={project.demo} className="text-gray-400 hover:text-blue-400 transition-all duration-200 hover:scale-110 hover:drop-shadow-[0_0_6px_rgba(59,130,246,0.6)]">
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-to-r from-pink-900/30 to-blue-900/30 rounded-xl p-8 border border-pink-500/20">
              ...
              <button className="bg-gradient-to-r from-pink-500 to-blue-500 text-white px-6 py-3 rounded-lg font-medium hover:from-pink-600 hover:to-blue-600 transition-all duration-200 flex items-center gap-2 mx-auto hover:scale-105">
                <Github size={20} />
                View GitHub Profile
              </button>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              <div className="flex space-x-4 pt-6">
                <a href="#" className="bg-slate-800 text-white p-3 rounded-lg hover:bg-slate-700 transition-all duration-200 border border-slate-600 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(148,163,184,0.6)]">
                  <Github size={24} />
                </a>
                <a href="#" className="bg-gradient-to-r from-pink-500 to-blue-500 text-white p-3 rounded-lg hover:from-pink-600 hover:to-blue-600 transition-all duration-200 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(244,114,182,0.6)]">
                  <Code size={24} />
                </a>
                <a href="#" className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white p-3 rounded-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-200 hover:scale-110 hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.6)]">
                  <Mail size={24} />
                </a>
              </div>
            </div>
            ...
            <div className="bg-slate-800/60 p-8 rounded-xl border border-pink-500/20">
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-pink-500 to-blue-500 text-white py-3 px-6 rounded-lg font-medium hover:from-pink-600 hover:to-blue-600 transition-all duration-200 flex items-center justify-center gap-2 hover:scale-105"
                >
                  Send Message
